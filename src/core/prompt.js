...
exports.prompt_handler = function prompt_handler(message, client) {
     ...
     *    asked question
     */
    if (waiting_answer_from.author !== null &&
...
exports.prompt = function prompt(client, message, question, delay = 60, keep_original_message = false) {
    return new Promise((resolve, reject) => {
        ...
        consume(client, message, `Please answer in less than ${delay}s`, question, 'blue', keep_original_message);
        setTimeout(() => {
            remove_waiting_answer();
            reject('timeout');
        }, delay * 1000);
